...
echo.
echo Setze temporaere Arcade-IP auf Client-PC...
echo Adapter: %ARCADE_ADAPTER%
echo IP:      192.168.10.2
echo.

netsh interface ip set address name="%ARCADE_ADAPTER%" static 192.168.10.2 255.255.255.0
if %errorlevel% neq 0 (
  echo.
...
echo Fertig. Dieser PC ist jetzt Client ^(192.168.10.2^).
exit /b 0
